...
| tbmq.customEnv                              | Custom environment variables for TBMQ configuration.                                                                                                                        | { SECURITY_MQTT_BASIC_ENABLED: "true" } |
| tbmq.existingConfigMap                      | Name of an existing TBMQ config map. Used mostly for JVM options. In the config map, key `conf` is expected.                                                                | ""                                      |
| tbmq.existingLogbackConfigMap               | Name of an existing TBMQ logback config map. Used mostly for JVM options. In the config map, key `logback` is expected.                                                     | ""                                      |
| **Health Checks**                           |                                                                                                                                                                             |                                         |
...
| tbmq.livenessProbe.tcpSocket.port           | Port checked to determine readiness.                                                                                                                                        | 1883                                    |
...
| **Environment, JVM and Logging Parameters** |                                                                                                                                                                             |                                       |
| tbmq-ie.customEnv                           | Custom environment variables for TBMQ IE configuration.                                                                                                                     | {}                                    |
| tbmq-ie.existingConfigMap                   | Name of an existing TBMQ IE config map. Used mostly for JVM options. In the config map, key `conf` is expected.                                                             | ""                                    |
| tbmq-ie.existingLogbackConfigMap            | Name of an existing TBMQ IE logback config map. Used mostly for JVM options. In the config map, key `logback` is expected.                                                  | ""                                    |
| **Health Checks**                           |                                                                                                                                                                             |                                       |
